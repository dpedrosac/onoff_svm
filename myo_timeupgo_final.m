function results = myo_timeupgo_final(maindir, nrep)
...
time_start_IMU2 = length(m2.timeIMU_log);                                   % and other recordings are sampled at a different frequency (200 vs. 50Hz)
